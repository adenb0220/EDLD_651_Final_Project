...
#### Abstract
The Population Assessment of Tobacco and Health (PATH) aims to investigate the important attitudes and behaviors of adolescents towards tobacco and nicotine-related substances. Prior research indicates that individual attitudes towards substances can affect substance use. We used this rich dataset to further look into research questions relating to smoker identification, beliefs about smoking cigarettes, and cigarette smoking behaviors in the past 30 days. While most results were null, we offer potential explanations including ceiling effects and lack of statistical power. We did find that identification as a smoker significantly predicts smoking behavior. Future research can seek to disrupt this smoker identification to decrease subsequent smoking behavior, as well as continue researching the effects of cigarette attitudes on smoking behavior. Future research should also ensure diverse datasets, representative by gender, race, and socioeconomic status, to fairly capture external factors relating to smoking behavior. 
...
Table 1 presents descriptive statistics of the full PATH study sample (n = 5,652). Table 2 presents descriptive statistics of the sample subset (n = 370) who responded affirmatively or negatively to the smoker identity question. Demographics were fairly consistent between those self-identified as smokers as compared to non-smokers for gender and race variables. However, there was a discrepancy for socioeconomic status, where the largest income group for non-smokers was \$50,000 to \$99,999 (28%), but for smokers was \$25,000 to \$49,999 (42%). Coefficients for logistic regression models predicting smoker identity represent the odds ratio (OR): in this case, the odds of a participant self-identifying as a smoker relative to their odds of identifying as a non-smoker given the presence/absence of a particular variable. As illustrated by Table 3, no levels of participants’ perceived harmfulness of cigarettes (modeled as a five-dimensional factor) were significantly associated with their odds of self-identifying as a smoker. These null results were replicated by subsequent analyses that modeled perceived cigarette harmfulness as a three-dimensional factor. As illustrated by Table 4, no levels of participants’ perceived likelihood of cigarette addiction (modeled as a five-dimensional factor) were significantly associated with their odds of self-identifying as a smoker. These null results were replicated by subsequent analyses that modeled perceived likelihood of addiction as a three-dimensional factor.

As illustrated by Table 5, no levels of participants’ perceived harmfulness of cigarettes (modeled as a five-dimensional factor) were significantly associated with their self-reported past-30-day frequency of cigarette use. These null results were replicated by subsequent analyses that modeled perceived cigarette harmfulness as a three-dimensional factor. As illustrated by Table 6, no levels of participants’ perceived likelihood of cigarette addiction (modeled as a five-dimensional factor) were significantly associated with their self-reported past-30-day frequency of cigarette use. These null results were replicated by subsequent analyses that modeled perceived likelihood of addiction as a three-dimensional factor. Last, as illustrated by Table 7, participants’ smoker identity was significantly associated (p \< 0.001) with their self-reported past-30-day frequency of cigarette use. On average in the study sample subset who either affirmed or denied smoker identity (n = 370), and while adjusting for age, sex, race, and SES, smoker identity was associated with 12.46 more days of cigarette use than non-smoker identity.
...
kable_table_total <- demographic_table_cleaned %>%
  kbl(caption = "Table 1: Demographic Distribution of Participants", align = "c") %>%
  kable_styling(
    full_width = FALSE,
...
kable_table_smokers <- smoker_demographic_table_cleaned %>%
  kbl(caption = "Table 2: Demographic Distribution of Self-Identified Smokers and Non-Smokers", align = "c") %>%
  kable_styling(
    full_width = FALSE,
    bootstrap_options = c("striped", "hover", "condensed"))
kable_table_smokers
...
cons_age <-df_smokers %>%
  ...
  labs(
    ...
    y = "Average Number of Days Smoked Cigs in Past 30 Days",
    fill = "Smoker \n Status",
    title = "Average Days Smoked by Age Group and Smoker Status", 
...
## TABLE 3 ##
kable(m1_coef, caption = "Table 3: Associations Between Perceived Cigarette Harmfulness and Smoker Identity")
...
## TABLE 4 ##
kable(m2_coef, caption = "Table 4: Associations Between Beliefs about Likelihood of Addiction and Smoker Identity")
...
kable(m3_coef, caption = "Table 5: Associations between Perceived Cigarette Harmfulness and Past-30-Day Smoking Frequency (# Days Smoked)")
...
kable(m4_coef, caption = "Table 6: Associations Between Beliefs about Likelihood of Addiction and Past-30-Day Smoking Frequency (# Days Smoked)")
...
kable(m5_coef, caption = "Table 7: Associations Between Smoker Identity and Past-30-Day Smoking Frequency (# Days Smoked)")
