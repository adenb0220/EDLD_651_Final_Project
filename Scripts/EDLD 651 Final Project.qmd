...
kable_table <- demographic_table %>%
  kbl(caption = "Demographic Distribution of Participants", 
      col.names = c("Demographic Group", "Count", "Percentage"),
      digits = 2,  # Limit percentage to 2 decimal points
      align = c("l", "r", "r")) %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"), 
                full_width = FALSE) %>%
  column_spec(1, bold = TRUE) %>% # Bold the first column
  add_header_above(c(" " = 1, "Summary" = 2)) %>%
...
modelsummary(m5,stars = T, fmt = 2,
             ...
             output = "EDLD651_model5_table.jpg")
